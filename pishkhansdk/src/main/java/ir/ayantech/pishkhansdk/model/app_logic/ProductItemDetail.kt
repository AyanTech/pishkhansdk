...
fun String.getProductInquiryButtonText() =
    when (this) {
        ProductItemDetail.InquiryJusticeSharesPortfolio -> "استعلام سهام عدالت"
        ProductItemDetail.InquiryTrafficFinesCar -> "استعلام خلافی خودرو"
        ProductItemDetail.InquiryTrafficFinesCarSummary -> "استعلام خلافی خودرو"
        ProductItemDetail.InquiryTrafficFinesMotorcycle -> "استعلام خلافی موتور"
        ProductItemDetail.InquiryTrafficFinesMotorcycleSummary -> "استعلام خلافی موتور"
        ProductItemDetail.TopUpCharge -> "خرید شارژ"
        ProductItemDetail.TopUpInternetPackage -> "خرید بسته اینترنت"
        ProductItemDetail.InquiryPlateNumbers -> "استعلام پلاک\u200Cهای فعال"
        ProductItemDetail.InquiryDrivingLicenceNegativePoint -> "استعلام نمره منفی"
        ProductItemDetail.InquiryExitBanStatus -> "استعلام ممنوع الخروجی"
        ProductItemDetail.InquiryPassportStatus -> "پیگیری گذرنامه"
        ProductItemDetail.InquiryDrivingLicenceStatus -> "پیگیری گواهینامه"
        ProductItemDetail.InquiryIdentificationDocumentsStatusCar -> "پیگیری مدارک خودرو"
        ProductItemDetail.InquiryTechnicalExaminationCertificate -> "استعلام معاینه فنی"
        ProductItemDetail.InquirySocialSecurityInsuranceMedicalCredit -> "اعتبار دفترچه بیمه"
        ProductItemDetail.InquirySocialSecurityInsuranceRetirementReceipt -> "مشاهده فیش حقوقی"
        ProductItemDetail.InquirySocialSecurityInsuranceRetirement -> "مشاهده حکم بازنشستگی"
        ProductItemDetail.InquirySocialSecurityInsuranceHistory -> "مشاهده سوابق بیمه"
        ProductItemDetail.InquiryGovernmentRetirement -> "مشاهده حکم بازنشستگی"
        ProductItemDetail.InquiryGovernmentRetirementReceipt -> "مشاهده فیش حقوقی"
        ProductItemDetail.InquiryWaterBills -> "مشاهده قبض آب"
        ProductItemDetail.InquiryElectricBills -> "مشاهده قبض برق"
        ProductItemDetail.InquiryGasBillsByIdentifier,
        ProductItemDetail.InquiryGasBillsByParticipateCode -> "مشاهده قبض گاز"

        ProductItemDetail.InquiryLandlinePhoneBills -> "مشاهده قبض تلفن ثابت"
        ProductItemDetail.InquiryPaperBills -> "استعلام قبض کاغذی"
        ProductItemDetail.MOBILE -> "مشاهده قبض تلفن همراه"
        ProductItemDetail.InquiryGovernmentSubventionHistory -> "استعلام یارانه نقدی"
        ProductItemDetail.InquiryPropertyTolls -> "استعلام عوارض ملک"
        ProductItemDetail.InquiryMunicipalityTaxiFaresBills -> "پرداخت کرایه تاکسی"
        ProductItemDetail.InquiryFreewayTollBills -> "استعلام عوارض آزادراهی"
        ProductItemDetail.InquiryAnnualTollsCar -> "استعلام عوارض سالیانه"
        ProductItemDetail.InquiryTrafficPlanTollsCar -> "استعلام طرح ترافیک"
        ProductItemDetail.InquiryIbanByCardNumber,
        ProductItemDetail.InquiryIbanByAccountNumber -> "دریافت شبا"

        ProductItemDetail.InquiryAccountNumberByIban -> "دریافت شماره حساب"
        ProductItemDetail.InquiryTransferTaxCar -> "استعلام مالیات نقل و انتقال خودرو"
        ProductItemDetail.InquiryTransferTaxMotorcycle -> "استعلام مالیات نقل و انتقال موتور"
        ProductItemDetail.InquiryPostPackageTracking -> "پیگیری مرسوله پستی"
        ProductItemDetail.InquirySayadCheque -> "مشاهده وضعیت چک صیادی"
        ProductItemDetail.InquiryThirdPartyInsuranceCar -> "استعلام بیمه شخص ثالث"
        ProductItemDetail.InquiryIdentificationDocumentsStatusMotorcycle -> "پیگیری مدارک موتور"
        ProductItemDetail.InquirySocialSecurityInsuranceMedicalPrescription -> "مشاهده نسخه الکترونیک"
        ProductItemDetail.InquiryRealEstateContract -> "استعلام قرارداد و اجاره نامه"
        ProductItemDetail.InquiryVehicleAuthenticityByBarCode,
        ProductItemDetail.InquiryVehicleAuthenticityByDocumentNumber -> "تایید و ادامه"

        ProductItemDetail.InquiryTelecomRegisteredLines -> "مشاهده لیست سیم\u200Cکارت"
        ProductItemDetail.InquiryLivelihoodInformation -> "استعلام معیشتی"
        else -> ""
    }
